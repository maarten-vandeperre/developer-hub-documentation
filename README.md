...
oc get route $(oc get routes -n demo-project -o jsonpath='{range .items[*]}{.metadata.name}{"\n"}{end}' | grep developer-hub) \
  ...
  ; echo
```
* _In our case: backstage-developer-hub-demo-project.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com_
...
```shell
basedomain=apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com
```
...
spec:
  ...
  database:
    enableLocalDb: true
```
* Go to Developer Hub: _(in our case)_ backstage-developer-hub-demo-project.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com
...
#        metadataUrl: <keycloak_base_url>/realms/rhdh/.well-known/openid-configuration # ${AUTH_OIDC_METADATA_URL}
        metadataUrl: https://demo-keycloak-instance.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com/realms/rhdh/.well-known/openid-configuration # ${AUTH_OIDC_METADATA_URL}
...
catalog:
  providers:
    keycloakOrg:
      default:
        baseUrl: https://demo-keycloak-instance.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com
