...
* Apply the following yaml:  
    ...
    **!!! be aware to change the root domain (i.e., apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com) to your own domain.**
```yaml
...
spec:
  ...
  hostname:
    ...
    # adminUrl: 'https://admin.demo-keycloak-instance.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com'
    adminUrl: 'https://demo-keycloak-instance.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com'
    hostname: demo-keycloak-instance.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com
  instances: 1
```
...
```
* Log in into keycloak (i.e., https://demo-keycloak-instance.apps.cluster-djr6p.djr6p.sandbox1644.opentlc.com/)
