...
* Apply the following yaml:  
    ...
    **!!! be aware to change the root domain (i.e., apps.cluster-jfx8l.sandbox2558.opentlc.com) to your own domain.**
```yaml
...
spec:
  ...
  hostname:
    ...
    # adminUrl: 'https://admin.demo-keycloak-instance.apps.cluster-jfx8l.sandbox2558.opentlc.com'
    adminUrl: 'https://demo-keycloak-instance.apps.cluster-jfx8l.sandbox2558.opentlc.com'
    hostname: demo-keycloak-instance.apps.cluster-jfx8l.sandbox2558.opentlc.com
  instances: 1
```
...
```
* Log in into keycloak (i.e., https://demo-keycloak-instance.apps.cluster-jfx8l.sandbox2558.opentlc.com/)
