...
export const parseGroup = async (
  ...
  groupTransformer?: GroupTransformer,
    ...
    console.info(`### debug keycloak parseGroup: schedule function`)
...
export const parseUser = async (
  ...
  userTransformer?: UserTransformer,
    ...
    console.info(`### debug keycloak plugin: parseUser function`)
...
export async function getEntities<T extends Users | Groups>(
  ...
  entityQuerySize: number = KEYCLOAK_ENTITY_QUERY_SIZE,
    ...
    console.info(`### debug keycloak plugin: getEntities function`)
...
export const readKeycloakRealm = async (
  ...
  groups: GroupEntity[];
    ...
    console.info(`### debug keycloak plugin: readKeycloakRealm async function`)
